...
public class MyAccountsPage extends Utility {
    ...
    public void enterFirstName() {
        sendTextToElement(firstName, "Saroj");
    }
    public void enterLastName() {
        sendTextToElement(lastName, "Malviya");
    }

    public void enterEMail() {
        String userName = "" + (int) (Math.random() * Integer.MAX_VALUE);            //Create random username
        String emailID = "User" + userName + "@test.com";
        sendTextToElement(this.emailId, emailID);
    }

    public void enterPhoneNumber() {
        sendTextToElement(mobileNumber, "07721541514");
    }

    public void enterPassword() {
        sendTextToElement(password, "sa1234");
    }

    public void enterConfirmPassword() {
        sendTextToElement(confirmPassword, "sa1234");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "sarojmalviya123@gmail.com");
    }
